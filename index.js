...
mongoose.connect("mongodb+srv://riyasafrith196:Riyas19@cluster0.gv1mq6d.mongodb.net/e-commerce")
...
app.post('/signup',async (req,res)=>{
    ...
    if(check){
        return res.status(400).json({success:false,error: "existing user found using same mail address" });
    }
    let cart={};
    for(let i=0;i<300;i++){
        cart[i]=0;
